...
from .schema import (
    ...
    AsrVoskSchema,
    AsrGoogleApiSchema,
    AsrMicrosoftApiSchema,
    AsrOpenaiApiSchema,
    PreprocessorNoiseReductionSchema,
    PreprocessorAudioNormalizerSchema,
    PreprocessorVoiceEnhancementSchema,
    AudioInputCaptureSchema,
    RedisSchema,
    RestApiSchema,
)
...
class ConfigManager(object):
    ...
    def _load_config(self):
        ...
        self.default = DefaultSchema(self._config['default'])
        self.asr_whisper = AsrWhisperSchema(self._config['asr_whisper'])
        self.asr_funasr = AsrFunasrSchema(self._config['asr_funasr'])
        self.asr_vosk = AsrVoskSchema(self._config['asr_vosk'])
        self.asr_google_api = AsrGoogleApiSchema(self._config['asr_google_api'])
        self.asr_microsoft_api = AsrMicrosoftApiSchema(self._config['asr_microsoft_api'])
        self.asr_openai_api = AsrOpenaiApiSchema(self._config['asr_openai_api'])
        self.preprocessor_noise_reduction = PreprocessorNoiseReductionSchema(self._config['preprocessor_noise_reduction'])
        self.preprocessor_audio_normalizer = PreprocessorAudioNormalizerSchema(self._config['preprocessor_audio_normalizer'])
        self.preprocessor_voice_enhancement = PreprocessorVoiceEnhancementSchema(self._config['preprocessor_voice_enhancement'])
        self.audio_input_capture = AudioInputCaptureSchema(self._config['audio_input_capture'])
        self.redis = RedisSchema(self._config['redis'])
        self.rest_api = RestApiSchema(self._config['rest_api'])
